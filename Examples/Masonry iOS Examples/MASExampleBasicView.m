...
//    redView.layer.borderWidth = 2;
    ...
    [redView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(greenView.topMargin);
        make.bottom.equalTo(greenView.bottomMargin);
        make.left.equalTo(greenView.leftMargin);
        make.right.equalTo(greenView.rightMargin);
    }];
